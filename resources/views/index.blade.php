...
<section id="content">
    <div class="container">
        ...
        <div class="card">
            ...
            <div id="recent-items-chart" class="flot-chart" style="padding: 0px; position: relative;"><canvas class="flot-base" width="577" height="150" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 577px; height: 150px;"></canvas><canvas class="flot-overlay" width="577" height="150" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 577px; height: 150px;"></canvas></div>
        </div>
    </div>
</section>
