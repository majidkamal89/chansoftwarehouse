...
class FacilitiesModel extends Model
{
	...
	public function getIndex(){
		...
		$facilityData = FacilitiesModel::orderby('FacilityName', 'ASC')->get();
		
		if(Request::ajax()){
			
			return Response::json(View('facilities.FacilitiesList')->with(array("facilityData"=>$facilityData)));
			
		}
		else{
			
			return View('facilities.index')->with(array("facilityData"=>$facilityData));
